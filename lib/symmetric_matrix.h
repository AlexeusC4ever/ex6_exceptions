...
public:
	...
	T& dereference() const { return *elem; } // Ïîëó÷åíèå òåêóùåãî ýëåìåíòà.
	T* pointer() const { return elem; }
	bool equal(const Position& other) const { return other.pointer() == elem; } // Ïðîâåðêà íà ðàâåíñòâî.
